            ...
            'groups' => [
                ...
                [
                    ...
                    'fields' => [
                        ...
                        'whatwedo_item1_title' => ['label' => 'Item 1 title', 'type' => 'text'],
                        'whatwedo_item1_text'  => ['label' => 'Item 1 text', 'type' => 'textarea'],
                        'whatwedo_item2_title' => ['label' => 'Item 2 title', 'type' => 'text'],
                        'whatwedo_item2_text'  => ['label' => 'Item 2 text', 'type' => 'textarea'],
                        'whatwedo_item3_title' => ['label' => 'Item 3 title', 'type' => 'text'],
                        'whatwedo_item3_text'  => ['label' => 'Item 3 text', 'type' => 'textarea'],
                        'whatwedo_item4_title' => ['label' => 'Item 4 title', 'type' => 'text'],
                        'whatwedo_item4_text'  => ['label' => 'Item 4 text', 'type' => 'textarea'],
                        'whatwedo_item5_title' => ['label' => 'Item 5 title', 'type' => 'text'],
                        'whatwedo_item5_text'  => ['label' => 'Item 5 text', 'type' => 'textarea'],
                    ],
                ],
                [
                    'title' => 'Vision',
