    ...
    <div class="wrap">
        ...
        <nav class="nav" id="nav">
            <ul class="nav-links">
                ...
                <li><a class="active" href="<?= e(BASE_URL) ?>/about">About us</a></li>
    ...
    <div class="wrap">
        <div class="about-cta-grid">
            <div class="about-cta-copy">
                ...
                <a href="<?= e(BASE_URL) ?>/contact" class="btn"><?= e($c('about_cta_button_label', 'Contact us')) ?> <span class="arrow">&rsaquo;</span></a>
            </div>
