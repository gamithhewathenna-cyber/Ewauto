    ...
    <div class="wrap">
        ...
        <nav class="nav" id="nav">
            ...
            <div class="nav-social">
                ...
                <a href="mailto:companyname@gamil.com" aria-label="Email"><svg viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2zm8 7L4 6.5V8l8 4.5L20 8V6.5L12 11z"/></svg></a>
...
<section class="hero">
    ...
    <div class="hero-pager">
        <button aria-label="Slide 1">1</button>
        <button aria-label="Slide 2">2</button>
        <button aria-label="Slide 3">3</button>
        <button aria-label="Slide 4">4</button>
    </div>
    <div class="wrap">
        <div class="hero-grid">
            <div class="hero-text">
                <p class="hero-eyebrow">LET'S RIDE THE</p>
                <h1 class="hero-title">DREAM</h1>
                <div class="hero-rule"><span class="dot"></span><span class="bar"></span></div>
                <p class="hero-copy">Lorem ipsum dolor sit amet consectetur. Erat dui rhoncus consectetur tincidunt. Mi felis odio consectetur est.</p>
                <div class="hero-cta">
                    <a href="#feature" class="btn">Learn more <span class="arrow">&rsaquo;</span></a>
                </div>
            </div>
            <div class="hero-visual">
                <?php if ($url = image_url($images, 'hero_scooter')): ?>
        ...
        <div class="spec-strip">
            <div class="spec"><div class="k">Battery</div><div class="v">Lead-acid/Lithiut</div></div>
            <div class="spec"><div class="k">Max Speed</div><div class="v">50/80km/h</div></div>
            <div class="spec"><div class="k">Range</div><div class="v">80/120km</div></div>
            <div class="spec"><div class="k">Weight allow</div><div class="v">150kg</div></div>
            <div class="spec"><div class="k">Motor</div><div class="v">1500/3000w</div></div>
        </div>
    </div>
</section>
    ...
    <div class="wrap">
        <div class="intro-grid">
            <div class="intro-copy">
                <p>Lorem ipsum dolor sit amet consectetur. Vel eget a sem amet leo sollicitudin tellus. Amet nunc urna sed sociis viverra urna hendrerit fringilla. Varius nec id egestas arcu pretium elit egestas in amet. Elementum accumsan blandit purus duis lorem tincidunt at.</p>
                <p>Vel quam placerat nunc sed. Arcu porta pretium consequat id vestibulum nullam. Sit sit faucibus sodales aliquet enim pharetra urna imperdiet. Scelerisque enim in sed commodo odio. Non nisl vestibulum convallis non sapien mattis. Viverra congue et viverra.</p>
            </div>
            <h2 class="intro-head">LOREM IPSUM DOLOR SIT AMET CONSECTETUR.</h2>
        </div>
    </div>
</section>
    ...
    <div class="wrap">
        <div class="feature-grid">
            <div class="feature-text">
                <h2 class="feature-title">KUNPENG</h2>
                <p class="feature-sub">Lorem ipsum dolor sit amet consectetur. Vel eget a sem.</p>
                ...
                <div class="feature-specs">
                    <div><div class="k">Max Speed</div><div class="v">50/80km/h</div></div>
                    <div><div class="k">Range</div><div class="v">80/120km</div></div>
                    <div><div class="k">Weight allow</div><div class="v">150kg</div></div>
                    <div><div class="k">Motor</div><div class="v">1500/3000w</div></div>
                    <div><div class="k">Battery</div><div class="v">Lead-acid/Lithiut</div></div>
                </div>
            </div>
...
<section class="world">
    <div class="wrap">
        <div class="world-head">
            <h2>WE ARE <span class="hl">WORLD WIDE REACH</span></h2>
            <p>Lorem ipsum dolor sit amet consectetur. Vel eget a sem amet leo sollicitudin tellus. Amet nunc urna sed sociis viverra urna hendrerit fringilla.</p>
        </div>
                ...
                <div class="testimonial">
                    <div class="testimonial-head">
                        ...
                        <div>
                            ...
                            <div class="role">Lorem ipsum</div>
                        </div>
                    </div>
                    <p>Lorem ipsum dolor sit amet consectetur. Nisl proin volutpat leo sed. Enim a rhoncus faucibus proin risus tincidunt. Proin mi nisl donec eu sociis nullam cursus rhoncus elit. Est eu ac iaculis iaculis consequat risus et. Ac molestie netus varius praesent.</p>
...
<section class="cta-band" id="contact">
    <div class="wrap">
        <div class="cta-card">
            ...
            <?php endif; ?>
            <div class="cta-inner">
                <h2>LOREM IPSUM DOLOR SITUR.</h2>
                <p>Lorem ipsum dolor sit amet consectetur. Vel eget a sem amet leo sollicitudin tellus. Amet nunc urna sed sociis viverra urna hendrerit fringilla.</p>
                <a href="#contact" class="btn btn-light">Contact us <span class="arrow">&rsaquo;</span></a>
            </div>
        </div>
        <div class="stats">
            <div class="stat"><div class="num">100+</div><div class="cap">Countries and<br>regions exports</div></div>
            <div class="stat"><div class="num">500+</div><div class="cap">Global<br>distributors</div></div>
            <div class="stat"><div class="num">5</div><div class="cap">Production bases:<small>Wuxi, Tianjin, Dongguan, Thailand, Indonesia</small></div></div>
            <div class="stat"><div class="num">3</div><div class="cap">Three branch<small>offices: Shenzhen, Poland, United States</small></div></div>
        </div>
    </div>
</section>
...
<footer class="site-footer">
    <div class="wrap">
        <div class="footer-grid">
            <div class="footer-brand">
                ...
                <?php endif; ?>
                <p>Lorem ipsum dolor sit amet consectetur. Pharetra at pretium fringilla nisl feugiat. Purus vel lectus faucibus non porttitor sit magna tincidunt tellus. Ut odio in vitae mollis tortor ultrices.</p>
            </div>
            ...
            <div class="footer-col footer-touch">
                ...
                <div class="row"><div class="a">companyname@gamil.com</div></div>
                <div class="row"><div class="q">Custom care?</div></div>
                <div class="row"><div class="a">(+391) 1234 8492</div></div>
            </div>
            <div class="footer-col">
    ...
    <div class="footer-bottom">
        ZXTec @2026, All Right reserved by Creativelements
    </div>
</footer>
